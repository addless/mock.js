describe('Data driven mock.js', function () {

    before(function () {
        driver = dataDriven('base/bridgevine/ux-ba-test/addless/mock.js/mock.json');
    });

    driver.it('data driven specs', function () {
        ...
        driver.setContextMetadata({
            ...
            .setHelperFunc(function helperFunc (lastScope, execute) {
                ...
                if(typeof execute === 'function') {
                    this.x.open('GET', 'base/addless/mock.js/spec/mock.json');
